...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
    const baseUrl = process.env.NEXT_PUBLIC_APP_URL || 'https://thejobpalace.in';
    ...
    // Wrap dynamic fetching in a global try-catch to prevent build failures
    try {
        ...
        try {
            ...
            console.error("Sitemap: Results query failed", e);
        }
        ...
        try {
            ...
            console.error("Sitemap: Admit cards query failed", e);
        }
        ...
        try {
            ...
            console.error("Sitemap: Answer keys query failed", e);
        }
        ...
        try {
            ...
            console.error("Sitemap: Syllabus query failed", e);
        }
        ...
        try {
            ...
            console.error("Sitemap: Admissions query failed", e);
        }
        ...
        console.error("CRITICAL SITEMAP ERROR: Returning static pages only.", globalError);
        return staticPages;
    }
}
